...
func (m model) View() string {
    switch m.st {
    case statusScanning:
        return m.headerText() + m.renderList()
    case statusReady:
        return m.headerText() + m.renderList()
    case statusConfirm:
        cnt := m.selectedCount()
...
func (m *model) headerText() string {
    ...
    case statusReady:
        return fmt.Sprintf("Found: %d  Total: %s  Selected: %s  | Keys: ↑↓ move, space select, s sort, r reverse, / filter, d/enter delete, q quit\n\n",
